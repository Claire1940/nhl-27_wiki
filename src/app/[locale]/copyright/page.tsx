...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - NHL 27 Wiki',
    description: 'Copyright and intellectual property information for NHL 27 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - NHL 27 Wiki',
      description: 'Copyright and intellectual property information for NHL 27 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 NHL 27 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of NHL 27 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              NHL 27 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Electronic Arts</strong> - Publisher of the EA SPORTS NHL series</li>
              <li><strong>NHL 27 Developers</strong> - Creators of the NHL 27 game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>EA SPORTS NHL</strong> - Trademark of Electronic Arts</li>
              <li><strong>NHL 27</strong> - Trademark of the game developers</li>
              <li><strong>NHL 27 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              NHL 27 Wiki<br />
              Email: <a href="mailto:dmca@nhl-27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@nhl-27.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "NHL 27 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: NHL 27 Wiki (nhl-27.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@nhl-27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@nhl-27.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@nhl-27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@nhl-27.wiki</a>
            </p>
            <p>
