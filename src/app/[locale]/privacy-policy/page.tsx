...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - NHL 27 Wiki',
    description: 'NHL 27 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our EA SPORTS NHL 27 resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              NHL 27 Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including EA, Reddit, YouTube, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              NHL 27 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Electronic Arts (EA) or the developers of NHL 27. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@nhl-27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@nhl-27.wiki</a>
            </p>
            <p>
