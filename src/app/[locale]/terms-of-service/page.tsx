...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.nhl-27.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - NHL 27 Wiki",
    description: "Read the Terms of Service for NHL 27 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our EA SPORTS NHL 27 resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "NHL 27 Wiki",
      title: "Terms of Service - NHL 27 Wiki",
      description: "Terms and conditions for using NHL 27 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using NHL 27 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using NHL 27 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and NHL 27 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              NHL 27 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to EA SPORTS NHL 27. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and mode strategies</li>
              <li>Franchise mode and GM Connected guides</li>
              <li>Platform and edition information</li>
              <li>HUT cards and market guides</li>
              <li>Be a Pro and career walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> NHL 27 Wiki is NOT affiliated with, endorsed by, or associated with
              Electronic Arts (EA) or the official developers of NHL 27. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by NHL 27 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Electronic Arts (EA) and/or the developers of NHL 27. We use such
            ...
            <ul>
              ...
              <li><strong>Release Timing:</strong> NHL 27 release windows, editions, and features may change without notice. We are not responsible for release date or content changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, NHL 27 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including EA, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and NHL 27 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@nhl-27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@nhl-27.wiki</a>
            </p>
            <p>
